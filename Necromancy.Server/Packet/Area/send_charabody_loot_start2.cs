...
namespace Necromancy.Server.Packet.Area
{
    public class send_charabody_loot_start2 : ClientHandler
    {
        ...
        public override void Handle(NecClient client, NecPacket packet)
        {
            ...
            if (fromZone == ItemZoneType.LootingBodyAdventureBag) fromZone = ItemZoneType.AdventureBag;
            if (fromZone == ItemZoneType.LootingBodyEquippedBags) fromZone = ItemZoneType.EquippedBags;
            if (fromZone == ItemZoneType.LootingBodyPremiumBag) fromZone = ItemZoneType.PremiumBag;
