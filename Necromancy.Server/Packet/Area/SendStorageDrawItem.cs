...
{
    public class SendStorageDrawItem : ClientHandler
    {
        private static readonly NecLogger _Logger = LogProvider.Logger<NecLogger>(typeof(SendStorageDrawItem));
        public SendStorageDrawItem(NecServer server) : base(server) { }
